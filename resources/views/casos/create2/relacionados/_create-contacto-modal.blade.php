<div id="modal2" class="modal">
	<form method="PUT" v-on="submit: submitContactosCreate">
		<div class="modal-content">
			...
			<div class="row">
				...
				<div class="input-field col s12 m6">
					<input type="hidden" value="Relacionado a Caso" v-model="newContacto.type"/>
				</div>
		...
		<div class="modal-footer">
			<a href="#!" class="modal-action modal-close waves-effect waves-green btn-flat" v-on="click: modalContactDestroy">Cancelar</a>
