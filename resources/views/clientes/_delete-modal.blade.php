<div id="modal2" class="modal">
	<div class="modal-content">
		...
		<p>¿Estas seguro de esta ejecutar esta operación?, vas a eliminar <strong class="red-text">@{{ cliente.name }}</strong> y sus registros relacionados, esta no se puede deshacer</p>
	</div>
